...
- **شبكات احتياطية** (Provider abstraction): PacketStream، Titan Network — قابلة للإضافة لاحقاً إذا أثبتت جدوى اقتصادية.
...
- بدائل احتياطية يجب دعمها بمرونة بالكود (Provider abstraction): PacketStream، Titan Network.
...
| **خدمات لاحقة** | PacketStream، Titan... | قابلة للإضافة بسهولة عبر `docker-compose.yml` |
...
- [ ] إمكانية إضافة شبكة جديدة (مثل PacketStream) بتعديل بسيط في الكود والـ `docker-compose.yml`.
